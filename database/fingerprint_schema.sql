...
CREATE TABLE IF NOT EXISTS attendance_logs (
  ...
  enroll_number TEXT, -- The raw enrollment number from the fingerprint device (for debugging)
...
-- Add enroll_number column to existing tables (safe migration)
...
-- Note: No anonymous access policies are created.
-- The Next.js API uses the SUPABASE_SERVICE_ROLE_KEY to safely bypass RLS.
